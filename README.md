...
Java coursework from Software I.

## Projects
- **CryptoUtilities** — Primality testing and modular arithmetic on large numbers.
- **Glossary** — Generates a linked HTML glossary from a text file of terms.
...
- **XMLTreeExpressionEvaluator** — Evaluates math expressions stored as XML trees.
  
## Tech
Java, OSU Component Library, JUnit
